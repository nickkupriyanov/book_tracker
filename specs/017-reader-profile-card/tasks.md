...
## T1. [x] Add reader profile model tests
...
## T2. [x] Implement reader profile model helper
...
## T3. [x] Add profile card component tests
...
## T4. [x] Implement ReaderProfileCard UI
...
## T5. [x] Wire the card into the home rail
