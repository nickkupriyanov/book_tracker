...
## T1. Add shared header and stats route tests
...
## T2. Implement shared header and stats placeholder
...
## T4. Add reading log domain and validation tests
...
## T5. Implement reading log type and validation
...
## T6. Add progress-to-log behavior tests
...
## T7. Implement progress-to-log saving
...
## T8. Redesign home reading cards and focus panel
...
- **Acceptance:** Home cards are vertical cover-led cards around 160px, title links to detail, card body selects active book, tag overflow is first two + `+N`, and focus panel shows cover/placeholder without jumping.
- **Notes:** Use the approved visual direction A.

## T9. Update calendar model for reading logs
